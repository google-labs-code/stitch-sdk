...
import { GenerateScreenFromTextResponse, ValidationError, ValidationErrorSchema, RateLimitError, RateLimitErrorSchema, ListScreensResponse, GetScreenResponse, CreateDesignSystemResponse, ListDesignSystemsResponse, UploadDesignMdResponse, CreateDesignSystemFromDesignMdResponse } from "./responses.generated.js";
...
export class Project {
    ...
    async generate(prompt: string, deviceType?: "DEVICE_TYPE_UNSPECIFIED" | "MOBILE" | "DESKTOP" | "TABLET" | "AGNOSTIC", modelId?: "MODEL_ID_UNSPECIFIED" | "GEMINI_3_PRO" | "GEMINI_3_FLASH" | "GEMINI_3_1_PRO"): Promise<Screen> {
        try {
          const raw = await this.client.callTool<GenerateScreenFromTextResponse>("generate_screen_from_text", { projectId: this.projectId, prompt, deviceType, modelId }, { "ValidationError": { schema: ValidationErrorSchema, match: "VALIDATION_ERROR", create: (data, raw) => new ValidationError("Tool Call Failed [generate_screen_from_text]: " + (ValidationErrorSchema.description || "VALIDATION_ERROR"), data, raw) }, "RateLimitError": { schema: RateLimitErrorSchema, match: "RATE_LIMITED", create: (data, raw) => new RateLimitError("Tool Call Failed [generate_screen_from_text]: " + (RateLimitErrorSchema.description || "RATE_LIMITED"), data, raw) } });
